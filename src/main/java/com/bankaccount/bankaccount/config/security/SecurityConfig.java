...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(LoginPrincipalService loginPrincipalService) {
        this.loginPrincipalService = loginPrincipalService;
    }
    ...
    public AuthenticationManager authManager(HttpSecurity http)
        ...
        return http.getSharedObject(AuthenticationManagerBuilder.class)
                .userDetailsService(loginPrincipalService)
